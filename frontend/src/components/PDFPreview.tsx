    ...
    if (file) {
      ...
      setTimeout(() => {
        try {
          ...
          setErrorMessage("Failed to reload the PDF. It may be corrupted or password-protected.");
          setIsRetrying(false);
          setIsLoading(false);
        }
      }, 800);
      ...
      <div className="relative bg-white text-gray-800 border border-gray-200 rounded-lg w-[95vw] h-[90vh] flex flex-col shadow-2xl overflow-hidden">
        ...
        <div className="flex items-center justify-between p-3 border-b border-gray-200 bg-gray-50">
          <h3 className="font-medium flex items-center gap-2 text-gray-700">
            ...
            <span className="text-gray-500 text-sm font-normal truncate max-w-md">{file?.name}</span>
          </h3>
          <button 
            onClick={onClose}
          ...
          {isLoading ? (
            ...
            <div className="flex items-center justify-center w-full h-full">
              <div className="text-center p-10 max-w-md bg-white rounded-lg border border-red-200 shadow-lg">
                ...
                <h3 className="text-xl font-semibold text-gray-800 mb-3">PDF Error</h3>
            ...
            <iframe 
              ...
              onError={() => setErrorMessage("This PDF could not be loaded. It may be corrupted or password-protected.")}
