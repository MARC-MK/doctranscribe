      ...
      <section className="bg-gradient-to-br from-background to-background-light rounded-xl p-8 shadow-lg">
        <div className="max-w-3xl">
          <h1 className="text-4xl font-bold mb-4">
            Transform Handwritten Survey Data into Digital Insights
          </h1>
          <p className="text-xl text-gray-300 mb-8">
            Upload handwritten survey PDFs and convert them into structured,
            analyzable Excel spreadsheets within minutes using advanced AI
            technology.
          </p>
            ...
            <table className="w-full text-sm">
              ...
              <tbody>
                {recentBatches.map((batch, index) => (
                  <tr
                    key={index}
                    className="border-t border-background-light hover:bg-background/50 transition"
                  >
